...
from research.domain import KnownEvent, utc
from research.evaluation import EventEvaluator
from research.storage import append_jsonl, read_json, read_jsonl, write_json


class AnalyticsPanel(QWidget):
    """Plots persisted calculation outputs; Known Events enter here only after scoring."""
    ...
    def add_known_event(self):
        from research.domain import iso, now_utc
