...
class RawBatchStore:
    ...
    def append(self, batch: YouTubeBatch) -> None:
        """Append a serialized YouTubeBatch as a JSON line."""
    ...
    def read_all(self) -> Iterator[YouTubeBatch]:
        """Read and yield all YouTubeBatch instances from the store."""
...
def batch_from_dict(payload: dict) -> YouTubeBatch:
    """Deserialize a dictionary payload into a YouTubeBatch."""
